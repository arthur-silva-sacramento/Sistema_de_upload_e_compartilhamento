...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['url'])) {
    ...
    $successMessage = '<a href="' . htmlspecialchars($relativeFilePath) . '" target="_blank">URL salva com sucesso!</a>';
    $successMessage =  $successMessage . ' <a href="' . htmlspecialchars("{$categoryDateDir}/{$urlHash}.json") . '" target="_blank">[ver arquivo JSON]</a>';
    ...
    <script>
        function toggleMoreOptions() {
            ...
            if (options.style.display === 'none' || options.style.display === '') {
                ...
                toggleText.innerText = 'Menos opções';
            } else {
                options.style.display = 'none';
                toggleText.innerText = 'Mais opções';
            }
        }
    </script>
</head>
<body>
    <div class="container">
        ...
        <div align="right"><a href="downloader_search.php">Pesquisa</a> <a href="downloader.php">ENG</a></div>
        ...
        <form method="post" action="">
            <div class="url-input-group">
                <input type="text" id="url" name="url" placeholder="Insira o endereço aqui (exemplo: https://example.com/file.pdf)" required>
                <input type="submit" value="Compartilhar">
            </div>
            
            <div class="more-options-toggle" onclick="toggleMoreOptions()">
                <span id="toggle-text">Mais opções</span>
            </div>
            ...
            <div id="more-options" class="more-options">
                ...
                <input type="text" id="btc" name="btc" placeholder="Endereço de Bitcoin para doações">
                
                <label for="pix">Chave PIX</label>
                <input type="text" id="pix" name="pix" placeholder="Sua chave PIX para doações">
            </div>
        </form>
    </div>
